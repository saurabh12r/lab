...
const DUMMY_REVIEWS: Review[] = [
  { id: "RV-1001", customerName: "Michael Roberts", initials: "MR", rating: 5, title: "Excellent service and quick results", message: "The staff was incredibly professional and the facility was spotless. I received my comprehensive blood panel results within 24 hours via their secure portal. Highly recommend MediLab for any diagnostic needs.", service: "Comprehensive Blood Panel", submissionDate: "Oct 24, 2026", status: "Approved" },
  { id: "RV-1002", customerName: "Sarah Lewis", initials: "SL", rating: 4, title: "Good overall, slight delay", message: "The phlebotomist was very gentle, didn't feel a thing. However, I had to wait about 20 minutes past my appointment time. Results were delivered promptly the next day.", service: "Thyroid Panel", submissionDate: "Oct 26, 2026", status: "Pending" },
  { id: "RV-1003", customerName: "John Doe", initials: "JD", rating: 2, title: "Confusing parking", message: "The test was fine but finding the parking lot was a nightmare. Your website needs better directions. Will probably go somewhere else next time just to avoid the hassle.", service: "Routine Checkup", submissionDate: "Oct 20, 2026", status: "Hidden" },
  { id: "RV-1004", customerName: "Emily Parker", initials: "EP", rating: 5, title: "Lifesavers!", message: "I needed emergency STAT testing before a flight and they accommodated me immediately. The results were pushed to my app within 4 hours. Incredible service, thank you!", service: "PCR Test", submissionDate: "Oct 18, 2026", status: "Approved" },
  { id: "RV-1005", customerName: "Alex Chen", initials: "AC", rating: 5, title: "Smooth experience", message: "Booking online was easy, and the lab was clean and organized. Got my lipid profile results the same day. Very satisfied.", service: "Lipid Profile", submissionDate: "Oct 22, 2026", status: "Pending" },
  { id: "RV-1006", customerName: "Maria Garcia", initials: "MG", rating: 4, title: "Professional and efficient", message: "Quick in and out. The nurse explained everything clearly. Only minor wait at checkout.", service: "CBC Panel", submissionDate: "Oct 19, 2026", status: "Approved" },
];
